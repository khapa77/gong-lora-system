...
- Остальные footprint'ы (HLK-10M05, SOT-223 LD1117V33, электролиты, клеммники,
...
def sot223(x, y, ref, name, gnd_net, vout_net, vin_net):
    ...
    сверься с datasheet LD1117V33 перед фабрикацией.
    """
...
# ═══════════════════════════════════════════════════════════════
# ЗОНА B — цифра/RF (ESP32, LD1117V33, Ra-02, DS3231)
# ═══════════════════════════════════════════════════════════════
...
# U5 — LD1117V33 (SOT-223) + входные/выходные конденсаторы, у правого края ESP32
