...
> Настройка **сбалансированная** (SF9, BW125, CR4/5) — airtime пакета ~150 мс. Сервер не блокируется на передаче, синхронность гонга ±0.15 сек. Дальность в городе ~500–800 м, на участке/ЛОС — до 4–5 км. Duty cycle позволяет слать каждые ~15 сек.
