...
> Настройка **максимальной чувствительности** (SF12, узкий BW, сильный FEC) — для работы на плохих антеннах / больших дистанциях. Airtime пакета ~1.2 сек. Task WDT увеличен до 15с.
